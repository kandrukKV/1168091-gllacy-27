var modalFeedback=document.querySelector('.modal-feedback');var form=modalFeedback.querySelector('form');var userNameField=document.querySelector('#user-name');var emailField=document.querySelector('#user-email');var messageField=document.querySelector('#mess');var mailingBtn=document.querySelector('.map-descr .btn');var mdalCloseBtn=document.querySelector('.modal-close');var malingForm=document.querySelector('.mailing form');var malingEmail=document.querySelector('#mailing');var userName='';var email='';var isStoreSupport=!0;try{userName=localStorage.getItem('userName');email=localStorage.getItem('email')}catch(e){isStoreSupport=!1}
